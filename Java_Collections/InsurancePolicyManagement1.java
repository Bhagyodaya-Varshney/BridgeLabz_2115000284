...
public class InsurancePolicyManagement1 {
    ...
    public static void main(String[] args) {
        ...
        cal.set(2023, Calendar.JANUARY, 20);
        Date date2 = cal.getTime();
        cal.set(2024, Calendar.MARCH, 8);
        Date date3 = cal.getTime();

        system.addPolicy(new InsurancePolicy("2001", "Anuj", date1, "Health", 2000));
        system.addPolicy(new InsurancePolicy("2002", "Bhagyodaya", date2, "Auto", 1900));
        system.addPolicy(new InsurancePolicy("2003", "Chitranshi", date3, "Home", 5200));
        system.addPolicy(new InsurancePolicy("2002", "Kunal", date2, "Auto", 3000));
